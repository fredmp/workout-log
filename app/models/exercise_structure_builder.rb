class ExerciseStructureBuilder
    ...
    exercise_map.each do |category_key, exercises|
      ...
      exercises.each do |exercise_entry|
        unless @existing_exercises_names.include?(exercise_entry[:name])
          ...
          exercise.save
          (exercise_entry[:body_parts] || []).each do |name|
            body_part = body_parts.find do |bp|
              ActiveSupport::Inflector.transliterate(name).downcase == ActiveSupport::Inflector.transliterate(bp.name).downcase
            end
            if body_part
              body_part.exercises << exercise
              body_part.save
            end
          end
        end
  ...
  def initial_body_parts
    @initial_body_parts ||= [
      I18n.t(:chest, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:back, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:shoulders, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:triceps, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:biceps, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:abdomen, scope: [:builders, :body_parts], locale: @locale),
      I18n.t(:legs, scope: [:builders, :body_parts], locale: @locale)
    ]
  end
  ...
  def initial_exercise_map_pt
    @initial_exercise_map_pt ||= {
      ...
      strength: [
        # Chest
        { name: 'Supino reto', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Supino 45', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Supino 90', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Supino declinado', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Flexões', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Supino com halteres', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Supino reto máquina', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Voador', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Voador com halteres', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Voador com halteres inclinado', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Voador com halteres declinado', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Crucifixo', body_parts: ['peitoral'], fields: '1-2' },
        { name: 'Cabo crossover', body_parts: ['peitoral'], fields: '1-2' },
        # Back
        { name: 'Puxada frontal aberta', body_parts: ['costas'], fields: '1-2' },
        { name: 'Puxada frontal fechada', body_parts: ['costas'], fields: '1-2' },
        { name: 'Puxada costas', body_parts: ['costas'], fields: '1-2' },
        { name: 'Remada sentado aberta', body_parts: ['costas'], fields: '1-2' },
        { name: 'Remada sentado fechada', body_parts: ['costas'], fields: '1-2' },
        { name: 'Remada cavalinho aberta', body_parts: ['costas'], fields: '1-2' },
        { name: 'Remada cavalinho fechada', body_parts: ['costas'], fields: '1-2' },
        # Shoulders
        { name: 'Ombro cabo elevação unilateral', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Ombro halter elevação unilateral', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Ombros halteres elevação bilateral', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Ombros halteres elevação frontal', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Desenvolvimento ombros barra', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Desenvolvimento ombros halteres', body_parts: ['ombros'], fields: '1-2' },
        { name: 'Elevação de ombros', body_parts: ['ombros'], fields: '1-2' },
        # Triceps
        { name: 'Tríceps máquina barra reta', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps máquina barra v', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps corda', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps mergulho', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps halteres sobre os ombros', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps barra w sentado', body_parts: ['tríceps'], fields: '1-2' },
        { name: 'Tríceps barra w deitado', body_parts: ['tríceps'], fields: '1-2' },
        # Biceps:
        { name: 'Bíceps barra reta', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps barra w', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres alternado', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres martelo', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres rotacionado', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps barra w banco scott', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres banco scott', body_parts: ['bíceps'], fields: '1-2' },
        { name: 'Bíceps halteres martelo banco scott', body_parts: ['bíceps'], fields: '1-2' },
        # Abdomen:
        ...
        # Legs:
        { name: 'Agachamento com barra', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Agachamento com barra frontal', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Agachamento máquina', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Leg press 45', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Cadeira extensora', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Cadeira adutora', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Cadeira abdutora', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Mesa flexora', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Máquina de glúteos', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Máquina de panturrilhas', body_parts: ['pernas'], fields: '1-2' },
        { name: 'Levantamento de barra', body_parts: ['pernas'], fields: '1-2' }
      ]
    }
  end
